...
<body class="">
<div role="navigation" class="navbar navbar-expand-lg navbar-light bg-light fixed-top head-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a href="../HOME/home.php" class="navbar-brand" style="background: #fff">
			<img src="images/logo.png" width="190" height="50" style="margin-left: -15%; margin-top: -5px">
		  </a>
