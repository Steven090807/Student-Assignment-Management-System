  ...
  <div class="submit-wrapper">
    ...
    <div class="submit-panel-all">
      ...
      <div class="submit-panel">
        <h3>Update by <span class="status">Assigned</span></h3>
        <input type="hidden" id="topic" value="Update..">
        <input type="hidden" id="homework-title" value="<?= htmlspecialchars($_GET['homework_title'] ?? '') ?>">
        <input type="hidden" id="due-date" value="">
        <input type="hidden" name="class_name" value="<?= htmlspecialchars($_GET['className'] ?? '') ?>">
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  submitBtn.addEventListener("click", function (e) {
    ...
    if (!topicEl || !titleEl || !dueEl || !fileInput) {
      alert("Some required input fields are missing in the HTML!");
      return;
    }
