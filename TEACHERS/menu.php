...
<div id="top-nav" class="navbar navbar-inverse navbar-static-top" style="background:#cc0000;color:white;border-color:white;">
...
<div class="col-lg-2 col-md-2 col-sm-3 col-xs-12">
    <div class="sidebar">
        ...
        <?php
            if (
            basename($_SERVER['PHP_SELF']) === 'assignment.php' ||
            basename($_SERVER['PHP_SELF']) === 'classwork_01.php' ||
            basename($_SERVER['PHP_SELF']) === 'classwork_02.php' ||
            basename($_SERVER['PHP_SELF']) === 'people.php' ||
            basename($_SERVER['PHP_SELF']) === 'teacher_grades.php' ||
            basename($_SERVER['PHP_SELF']) === 'student_grades.php' 
        ): ?>
...
<?php if (
    ...
    <div class="topic">    
        ...
        <!-- <div class="nav-item" id="three">
            <a href="teacher_grades.php?className=<?= urlencode($className) ?>">Grades</a>
        </div> -->
    </div>
<?php endif; ?> 
